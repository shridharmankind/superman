...
const singleDailyRecord = async (dbInstance,schema,object,monthlyObjectId) => {
    try{
        ...
        await dbInstance.write(() => {
            ...
            let monthlyPlanObject = dbInstance.objectForPrimaryKey(schema[0].name, monthlyObjectId);
